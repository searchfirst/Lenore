...
<div class="content">
<p><?php echo $html->link(sprintf('< Back to %s: %s',Configure::read('Product.alias'),$product['Product']['title']),array('admin'=>true,'controller'=>'products','action'=>'view',$product['Product']['id'])); ?></p>
