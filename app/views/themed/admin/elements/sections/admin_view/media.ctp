...
<?php if(!empty($section['Decorative'])): ?>
<?php echo $this->element('deco_image',array(
	'deco_id'=>$section['Decorative'][0]['id'],'deco_title'=>$section['Decorative'][0]['title'],'parent'=>$section,'model'=>'Section'
));?> 
<?php else: ?>
<?php echo $this->element('deco_image_empty',array('parent'=>$section));?> 
<?php endif ?>
