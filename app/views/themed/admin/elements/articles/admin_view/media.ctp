...
<?php
if(!empty($section['Decorative'])) echo $this->element('deco_image',array('deco_id'=>$article['Decorative'][0]['id'],
	'deco_title'=>$article['Decorative'][0]['title'],'parent'=>$article));
else echo $this->element('deco_image_empty',array('model'=>'Article','parent'=>$article));
?> 
