...
<?php echo $this->element('deco_image',array(
	'deco_id'=>$category['Decorative'][0]['id'],'deco_title'=>$category['Decorative'][0]['title'],'parent'=>$category,'model'=>'Category'
));?> 
<?php else: ?>
<?php echo $this->element('deco_image_empty',array('parent'=>$category));?> 
<?php endif ?>
