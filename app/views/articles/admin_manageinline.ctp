...
<div class="content">
<p><?php echo $html->link(sprintf('< Back to %s: %s',Configure::read('Article.alias'),$article['Article']['title']),array('admin'=>true,'controller'=>'articles','action'=>'view',$article['Article']['id'])); ?></p>
