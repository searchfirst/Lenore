...
<div class="content">
<p><?php echo $html->link(sprintf('< Back to %s: %s',Configure::read('Category.alias'),$category['Category']['title']),array('admin'=>true,'controller'=>'categories','action'=>'view',$category['Category']['id'])); ?></p>
...
<?php endfor;?>
<?php echo $form->end('Upload inline media')?> 
<?php endif;?>
</div>