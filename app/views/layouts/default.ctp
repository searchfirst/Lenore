...
<head>
<meta charset="utf-8">
<title><?php echo $textAssistant->sanitiseText($title_for_layout);?> | <?php echo $textAssistant->sanitiseText(Configure::read('Moonlight.website_name')) ?></title>
<?php if(!empty($metadata_for_layout)) echo $this->element('metadata');?> 
